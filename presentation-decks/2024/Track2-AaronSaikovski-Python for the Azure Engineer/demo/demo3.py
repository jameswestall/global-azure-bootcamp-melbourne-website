# source: https://learn.microsoft.com/en-us/azure/developer/python/sdk/examples/azure-sdk-example-storage?tabs=cmd
...
STORAGE_ACCOUNT_NAME = f"pysamplestg{random.randint(1,100000):05}"
